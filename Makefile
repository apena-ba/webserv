...
SRC = src/main.cpp src/Cluster.cpp src/Server.cpp src/Port.cpp src/HTTPRequestParser.cpp \
	...
	src/ConfigurationParser/utils/_TempRoute.cpp src/ConfigurationParser/utils/ParsingUtils.cpp src/Configuration.cpp

OBJ = obj/main.o obj/Cluster.o obj/Server.o obj/Port.o obj/HTTPRequestParser.o obj/ConfigurationParser.o \
	obj/_TempConfiguration.o obj/_TempRoute.o obj/ParsingUtils.o obj/Configuration.o
